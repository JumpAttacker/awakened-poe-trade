...
export default {
  ...
  ULTIMATUM_SACRIFICE: /^Требуется жертвоприношение: (.+?)(?:\sx(\d+))?$/,
  ...
  HEIST_ESCAPE_ROUTES: 'Путей отхода обнаружено: ',
  HEIST_REWARD_ROOMS: 'Комнат с наградами обнаружено: ',
  HEIST_ITEM_QUANTITY: 'Количество предметов: ',
  HEIST_ITEM_RARITY: 'Редкость предметов: ',
