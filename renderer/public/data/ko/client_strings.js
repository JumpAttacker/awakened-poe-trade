...
export default {
  ...
  ULTIMATUM_SACRIFICE: /^Requires Sacrifice: (.+?)(?:\sx(\d+))?$/,
  ...
  HEIST_ESCAPE_ROUTES: 'Escape Routes Revealed: ',
  HEIST_REWARD_ROOMS: 'Reward Rooms Revealed: ',
  HEIST_ITEM_QUANTITY: 'Item Quantity: ',
  HEIST_ITEM_RARITY: 'Item Rarity: ',
